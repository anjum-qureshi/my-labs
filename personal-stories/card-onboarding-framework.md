***Business Context***
    ...
    Card logic of what controls need to be shown. 
    How the card looks and text configurations on card was all hardcoded in code.
    Images to be showns for the front were saved locally.
